...
def step1():
	############## normalise mesh by area ###############
	print('\nNormalising by area:')
	normalise_mesh(name, normalisation='A', rotate=False)
...
def step3():
	...
	shutil.copy( '/Users/romywilliamson/Documents/SphericalNS/sns/data/'+name+'_final_embedding.obj' ,
		      '/Users/romywilliamson/Documents/SphericalNS/sns/data/000temp_final_embedding.obj' )

	######################## make a pth file for the parametrisation ################################################
	print('\nMaking a pth file for the parametrisation.')
	os.system('python -m scripts.sphere_process_surface_sample --data /Users/romywilliamson/Documents/SphericalNS/sns/data/'+name+'_nA.obj --square')
...
def step4():
	...
	with open('/Users/romywilliamson/Documents/SphericalNS/sns/neural_surfaces-main/experiments/overfit/GENERIC.json') as generic_file:
	...
	with open('/Users/romywilliamson/Documents/SphericalNS/sns/neural_surfaces-main/experiments/overfit/'+name+'.json', "w") as text_file:
