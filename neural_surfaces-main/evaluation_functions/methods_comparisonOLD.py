...
class Anal_Surface_Evaluator:
	...
	def load_surf_mesh(self, level=6):
		self.meshpath = '../data/'+self.surf_name+str(level)+'.obj'
...
name_mesh_dict = {'SPIKE' : ['S-analytic-SNS',  'S-remesh4', 'S-remesh5', 'S-remesh6'],
					...
					'SMALLTREE' : ['SMALLTREE',  'SMALLTREE4', 'SMALLTREE5', 'SMALLTREE6'],
					'SMALLFLOWER' : ['SMALLFLOWER',  'SMALLFLOWER4', 'SMALLFLOWER5', 'SMALLFLOWER6'],
					'SMALLBOBBLE' : ['SMALLBOBBLE',  'SMALLBOBBLE4', 'SMALLBOBBLE5', 'SMALLBOBBLE6'],
					'SMALLSPIKE' : ['SMALLSPIKE',  'SMALLSPIKE4', 'SMALLSPIKE5', 'SMALLSPIKE6']
					}
...
quantity = sys.argv[-2] # normals, H or K
quantities = [quantity]

plot_type = sys.argv[-1] # error or dist



methods = ['gt', 'i3d', 'NFGP', 'monge'] #don't include SNS here
...
plt.savefig('../data/plots/'+surf_name+quantity+plot_type+'.pdf', dpi=300 )
