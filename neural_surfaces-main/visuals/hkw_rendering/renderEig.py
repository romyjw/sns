...
filepath = "../data/visualisation/eigenfunc/"+SNSname+"/"+SNSname+".ply"
...
for i in range(n):
    colouringname = 'eigfunc_'+str(i+1)
...
config.sensor.location = [0, 1, 3]#for froggo
...
for colouringname, base in base_dict.items():
    ...
    hkw.render(base, config, filename="../data/visualisation/eigenfunc/"+SNSname+"/"+colouringname+".png")
