...
class ExperimentRunner(GenericRunner):
    ...
    def train_step(self, batch, epoch):###############changed12.04
        return self.experiment['tasks']['train'].run(batch, self.model, self.experiment, epoch)#################changed12.04
